...
See **[DDScope_AI_UI.md](DDScope_AI_UI.md)** for the full AI assistant panel specification: header controls, replay player bar, export/import file format, and instructions modal.
